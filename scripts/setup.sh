...
sudo apt install -y util-linux procps hostapd iproute2 iw haveged dnsmasq iptables espeak git-lfs fonts-wqy-zenhei
...
cd $PWD
python -m venv --system-site-packages /home/$(logname)/ugv_jetson/ugv-env
...
# OAK Config
sudo cp -v -f /home/$(logname)/ugv_jetson/99-dai.rules /etc/udev/rules.d/99-dai.rules
